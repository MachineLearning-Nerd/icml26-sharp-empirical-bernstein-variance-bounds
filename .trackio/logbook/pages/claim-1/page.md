...
---
<!-- trackio-cell
{"type": "markdown", "id": "cell_2eb6987b9dd7", "created_at": "2026-07-20T09:52:32+00:00", "title": "Constant conditional moments"}
-->
Independent 80-digit enumeration checks 3,800 conditional exponential-supermartingale multipliers over two bounded adaptive-switchable laws that preserve conditional mean and variance. The omitted mean-estimation correction is a required negative control.


---
<!-- trackio-cell
{"type": "code", "id": "cell_2b9cd751f413", "created_at": "2026-07-20T09:52:58+00:00", "title": "Independent high-precision certificates", "command": ["python", "repro/src/verify_empirical_bernstein.py", "--output", "outputs/independent_certificate.json"], "exit_code": 0, "duration_s": 1.026}
-->
````bash
$ python repro/src/verify_empirical_bernstein.py --output outputs/independent_certificate.json
````

exit 0 · 1.0s


````python title=verify_empirical_bernstein.py
#!/usr/bin/env python3
...
def source_manifest() -> dict:
    ...
    assert (ROOT / "upstream" / ".git").is_dir()
...
````json title=independent_certificate.json
{
  "claim_outcomes": {
    "claim_1_constant_conditional_moments": {
      "cells": 3800,
      "max_supermartingale_multiplier": "1.0",
      "negative_control_omitted_mean_error_multiplier": "1.11174853238868829",
      "outcome": "passed",
      "scope": "all 3,800 high-precision conditional multiplier cells for two adaptive-switchable bounded laws with fixed conditional mean and variance"
    },
    "claim_2_iid_asymptotic_sharpness": {
      "cells": 36,
      "max_relative_error_across_all_finite_horizons": "0.25972734349275493",
      "max_relative_error_at_n_1e10": "0.000161917862887044265",
      "negative_control_wrong_quadratic_psi_ratio": "1.5",
      "outcome": "passed",
      "scope": "first-order radius optimization for three fourth-moment variances, three confidence levels, and four large fixed horizons"
    },
    "claim_3_separable_hilbert_extension": {
      "cells": 960,
      "max_supermartingale_multiplier": "1.0",
      "negative_control_omitted_vector_mean_error_multiplier": "1.03096527010360196",
      "outcome": "passed",
      "scope": "all 960 high-precision non-collinear finite-dimensional Hilbert-space multiplier cells"
    }
  },
  ...
  "source_manifest": {
    ...
    "archive_sha256": "b95e61d7af9dcd5f8a08275e1d88af13fc8af85adc7eeb4d3c64d275de0830c1",
    "arxiv": "2505.01987v2",
    "upstream_commit": "e36d2d779e04d52604337ca093071a1f3051f129"
  },
  "status": "passed",
